      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-16">
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-8 border border-purple-500/20">
            <h2 className="text-3xl font-bold mb-4 text-purple-400">Our Mission</h2>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-purple-500/20">
              ...
              <p className="text-gray-400">3-5 second transaction finality vs minutes on other chains</p>
            </div>
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-purple-500/20">
              <Shield className="w-12 h-12 text-purple-400 mb-4" />
              <h3 className="text-xl font-bold mb-2">Ultra Cheap</h3>
              <p className="text-gray-400">$0.0001 per transaction vs $50+ on Ethereum</p>
            </div>
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-purple-500/20">
              <Target className="w-12 h-12 text-purple-400 mb-4" />
              <h3 className="text-xl font-bold mb-2">Eco-Friendly</h3>
              <p className="text-gray-400">Carbon negative blockchain with minimal energy use</p>
            </div>
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-purple-500/20">
              <Users className="w-12 h-12 text-purple-400 mb-4" />
              <h3 className="text-xl font-bold mb-2">Enterprise Grade</h3>
              <p className="text-gray-400">Used by Google, IBM, and major enterprises</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <p className="text-center text-gray-400 mb-8">All Hedera Certified Developers</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-purple-500/20 text-center">
              <div className="w-20 h-20 bg-gradient-to-br from-purple-400 to-pink-600 rounded-full mx-auto mb-4 flex items-center justify-center text-2xl font-bold">
                KO
              </div>
              <h3 className="text-xl font-bold mb-1">Karol Onyango</h3>
              <p className="text-purple-400 mb-2">Founder & Lead Developer</p>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-purple-500/20 text-center">
              ...
              <p className="text-purple-400 mb-2">Blockchain Developer</p>
              <p className="text-sm text-gray-400">Smart contract integration</p>
            </div>
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-purple-500/20 text-center">
              <div className="w-20 h-20 bg-gradient-to-br from-purple-400 to-pink-600 rounded-full mx-auto mb-4 flex items-center justify-center text-2xl font-bold">
                AO
              ...
              <p className="text-purple-400 mb-2">Blockchain Developer</p>
              <p className="text-sm text-gray-400">Distributed systems expert</p>
            </div>
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-purple-500/20 text-center">
              <div className="w-20 h-20 bg-gradient-to-br from-purple-400 to-pink-600 rounded-full mx-auto mb-4 flex items-center justify-center text-2xl font-bold">
                PN
        ...
        <div className="mb-16">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg p-8 text-center border border-purple-500/30">
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-lg p-8 text-center border border-purple-500/30">
              ...
              <div className="text-gray-400">Carbon Negative</div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-lg p-12 border border-purple-500/30">
            ...
            <div className="flex gap-4 justify-center">
              <a href="/mint" className="bg-gradient-to-r from-purple-500 to-pink-600 px-8 py-3 rounded-lg font-semibold hover:opacity-90 transition">
                Start Minting
              </a>
              <a href="/marketplace" className="bg-gray-700 px-8 py-3 rounded-lg font-semibold hover:bg-gray-600 transition">
                Browse Marketplace
              </a>
            </div>
          </div>
